class MindChoice {
  ...
  factory MindChoice.fromJson(Map<String, dynamic> json) {
    return MindChoice(
...
class MindComicCut {
  ...
  factory MindComicCut.fromJson(Map<String, dynamic> json) {
    return MindComicCut(
      cut: json['cut'] as int,
      text: json['text'] as String,
...
class MindReward {
  ...
  factory MindReward.fromJson(Map<String, dynamic> json) {
    return MindReward(
      type: json['type'] as String,
...
class MindStep1 {
  ...
  factory MindStep1.fromJson(Map<String, dynamic> json) {
    return MindStep1(
...
class MindStep2 {
  ...
  factory MindStep2.fromJson(Map<String, dynamic> json) {
    return MindStep2(
      title: json['title'] as String,
      ...
      choices: (json['choices'] as List)
          ...
          .toList(),
      imageUrl: json['imageUrl'] as String?,
      retryMessage: json['retryMessage'] as String,
      nextButtonText: json['nextButtonText'] as String,
    );
  }
...
class MindStep3 {
  ...
  factory MindStep3.fromJson(Map<String, dynamic> json) {
    return MindStep3(
      title: json['title'] as String,
      comic: (json['comic'] as List)
...
class MindStep4 {
  ...
  factory MindStep4.fromJson(Map<String, dynamic> json) {
    return MindStep4(
      title: json['title'] as String,
      ...
      reward: json['reward'] != null
          ...
          : null,
      completeButtonText: json['completeButtonText'] as String,
    );
  }
...
class MindSteps {
  ...
  factory MindSteps.fromJson(Map<String, dynamic> json) {
    return MindSteps(
      step1: MindStep1.fromJson(json['step1'] as Map<String, dynamic>),
...
class MindScenario {
  ...
  factory MindScenario.fromJson(Map<String, dynamic> json) {
    return MindScenario(
      setId: json['setId'] as String,
      emotion: json['emotion'] as String,
      situation: json['situation'] as String,
      learnedExpression: json['learnedExpression'] as String,
      steps: MindSteps.fromJson(json['steps'] as Map<String, dynamic>),
